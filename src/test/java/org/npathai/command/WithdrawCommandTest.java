...
class WithdrawCommandTest {
    ...
    public void returnsMessageWhenWithdrawalIsSuccessful() {
        assertThat(withdrawCommand.execute().lines()).containsExactly("Successfully withdrawn Rs 1000");
    }
    ...
    public void returnsClosureMessageWhenTriedToDepositAccountAfterClosingAccount() {
        ...
        assertThat(withdrawCommand.execute().lines()).contains("Account is closed, cannot make any transaction");
    }
    ...
    public void returnsMinimumBalanceNecessaryMessageWhenWithdrawingAmountThatCausesBalanceToGoBelowMinRequirement() {
        ...
        assertThat(withdrawCommand.execute().lines()).contains("Must maintain minimum balance of 500");
    }
}